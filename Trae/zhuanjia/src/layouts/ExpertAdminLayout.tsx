    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className={`${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transition-transform duration-300 ease-in-out`}>
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-xl font-bold text-gray-800">专家管理后台</h2>
          <button
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t">
          <a href="/expert/1" className="flex items-center space-x-3 p-3 text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors w-full">
            <LogOut size={20} />
            <span>退出登录</span>
          </a>
        </div>
